...
export default function Week(props) {
    ...
    new Classes("9th Grade"),
    new Classes("10th Grade"),
    new Classes("11th Grade"),
    new Classes("12th Grade"),
  ];
  ...
  return (
    <>
      ...
      {isTeachboxActive ? <AddTeacher addTeacher={handleClick2} cancelTeacher={handleClick} setSubConstraint={setSubConstraint} /> : ""}
