      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ms-auto"> {/* Align items to the right */}
          ...
          <NavDropdown title="Select a Class" id="basic-nav-dropdown">
            <NavDropdown.Item onClick={() => props.changeClass("Nursery")}>Nursery</NavDropdown.Item>
            <NavDropdown.Item onClick={() => props.changeClass("KG First")}>KG First</NavDropdown.Item>
            <NavDropdown.Item onClick={() => props.changeClass("KG Second")}>KG Second</NavDropdown.Item>
